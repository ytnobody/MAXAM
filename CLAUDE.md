...
作業の重複防止と進捗可視化のため、タスクボードへの記載を必須とする。

#### 記載タイミング
1. **作業開始時**: タスクを拾ったらすぐに記載
2. **完了時**: ステータスを更新
...
#### 運用ルール
- **宣言してから着手**: チャットで「#XX やります」と宣言 → タスクボード記載 → 作業開始
- **1タスク1担当**: 同一タスクを複数人が拾わない
- **更新を怠らない**: ステータス変更時は即更新
